...
/*   Updated: 2019/10/17 17:04:17 by crenly-b         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print_menu(t_map *map)
{
	...
	mlx_string_put(map->mlx_ptr, map->win_ptr,  1100, i += 30, color_of_board, "Rotate: Press & Move");
	...
	mlx_string_put(map->mlx_ptr, map->win_ptr,  1100, i += 25, color_of_board, "Y-Axis - 4/6");
